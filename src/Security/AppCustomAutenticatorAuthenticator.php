...
class AppCustomAutenticatorAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository(UserBase::class)->findOneBy(['email' => $credentials['email']]);
